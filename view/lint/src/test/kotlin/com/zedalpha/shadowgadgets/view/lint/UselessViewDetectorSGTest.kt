...
class UselessViewDetectorSGTest {
    ...
    fun `Useless parent and leaf ShadowsViewGroups warnings`() {
        lint()
            ...
            .expect(
                """
                res/layout/useless.xml:27: Warning: This com.zedalpha.shadowgadgets.view.viewgroup.ShadowsLinearLayout view is unnecessary (no children, no background, no id, no style) [UselessLeafSG]
                        <com.zedalpha.shadowgadgets.view.viewgroup.ShadowsLinearLayout
                         ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
