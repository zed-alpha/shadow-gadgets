 ...
 */
class ShadowsLinearLayout @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0,
    defStyleRes: Int = 0
) : ClippedShadowsLinearLayout(context, attrs, defStyleAttr, defStyleRes),
    ShadowsViewGroup {
...
/**
 * Replaced by [ShadowsLinearLayout]
 */
@Deprecated(
    "Replaced by ShadowsLinearLayout",
    ReplaceWith("ShadowsLinearLayout")
)
open class ClippedShadowsLinearLayout @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0,
    defStyleRes: Int = 0
