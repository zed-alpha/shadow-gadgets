...
internal class RenderNodeShadow : CoreShadow() {
    ...
    override val left: Int get() = shadowNode.left

    override val top: Int get() = shadowNode.top

    override val right: Int get() = shadowNode.right

    override val bottom: Int get() = shadowNode.bottom

    override fun setPosition(left: Int, top: Int, right: Int, bottom: Int) {
        shadowNode.setPosition(left, top, right, bottom)
    }
