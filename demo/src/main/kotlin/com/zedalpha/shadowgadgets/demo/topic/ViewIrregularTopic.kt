...
import com.zedalpha.shadowgadgets.demo.databinding.FragmentViewIrregularBinding
...
internal val ViewIrregularTopic =
    Topic(
        title = "View: Irregular",
        descriptionResId = R.string.description_view_irregular,
        fragmentClass = ViewIrregularFragment::class.java
    )

class ViewIrregularFragment :
    TopicFragment<FragmentViewIrregularBinding>(
        inflate = FragmentViewIrregularBinding::inflate
    ) {

    override fun loadUi(ui: FragmentViewIrregularBinding) {
