...
internal class RenderNodeApi29 : RenderNodeWrapper, RenderNodeColors {
    ...
    override fun getRotationZ(): Float = renderNode.rotationZ

    override fun setRotationZ(rotationZ: Float): Boolean = renderNode.setRotationZ(rotationZ)
    ...
    override fun getAmbientShadowColor(): Int = renderNode.ambientShadowColor

    override fun setAmbientShadowColor(color: Int): Boolean =
        renderNode.setAmbientShadowColor(color)

    override fun getSpotShadowColor(): Int = renderNode.spotShadowColor
