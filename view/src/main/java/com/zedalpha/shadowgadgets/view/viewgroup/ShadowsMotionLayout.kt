...
class ShadowsMotionLayout @JvmOverloads constructor(
    ...
    defStyleAttr: Int = 0
) : ClippedShadowsMotionLayout(context, attrs, defStyleAttr), ShadowsViewGroup {
...
/**
 * Replaced by [ShadowsMotionLayout]
 */
@Deprecated(
    "Replaced by ShadowsMotionLayout",
    ReplaceWith("ShadowsMotionLayout")
)
open class ClippedShadowsMotionLayout @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
