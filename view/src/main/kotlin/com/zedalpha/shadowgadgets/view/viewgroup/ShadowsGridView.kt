 ...
 */
class ShadowsGridView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = android.R.attr.gridViewStyle,
    defStyleRes: Int = 0
) : ClippedShadowsGridView(context, attrs, defStyleAttr, defStyleRes),
    ShadowsViewGroup {
 ...
 */
@Deprecated("Replaced by ShadowsGridView", ReplaceWith("ShadowsGridView"))
open class ClippedShadowsGridView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = android.R.attr.gridViewStyle,
    defStyleRes: Int = 0
