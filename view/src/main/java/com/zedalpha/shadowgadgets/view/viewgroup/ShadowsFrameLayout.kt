...
class ShadowsFrameLayout @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0,
    defStyleRes: Int = 0
) : ClippedShadowsFrameLayout(context, attrs, defStyleAttr, defStyleRes),
    ShadowsViewGroup {
...
@Deprecated(
    ...
    ReplaceWith("ShadowsFrameLayout")
)
open class ClippedShadowsFrameLayout @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0,
    defStyleRes: Int = 0
